...
const createAcademicFacultyInDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield academicFaculty_model_1.AcademicFaculty.create(payload);
    return result;
});
const getAllAcademicFacultiesInDB = () => __awaiter(void 0, void 0, void 0, function* () {
