...
const createFacultyValidateSchema = zod_1.z.object({
    body: zod_1.z.object({
        ...
        faculty: zod_1.z.object({
            ...
            emergencyContactNo: zod_1.z.string().min(1, "Emergency Contact No. Must be required!!"),
            ...
            academicDepartment: zod_1.z.string().min(1, "Academic Department ID is required"),
        })
    })
});
    ...
    body: zod_1.z.object({
        faculty: zod_1.z.object({
            ...
            emergencyContactNo: zod_1.z.string()
                ...
                .optional(),
            presentAddress: zod_1.z.string().min(1, "Present Address required!!").optional(),
            permanentAddress: zod_1.z.string().min(1, "Permanent Address required!!").optional(),
            profileImg: zod_1.z.string().optional(),
