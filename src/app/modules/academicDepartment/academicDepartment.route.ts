...
router.post('/create-academic-department',
    requestValidate(academicDepartmentValidation.CreateAcademicDepartmentValidation),
    academicDepartmentController.createAcademicDepartmentCont
);

router.get('/get-all-academic-departments',
    academicDepartmentController.getAllAcademicDepartmentCont
);

router.get('/get-single-academic-department/:departmentId',
    academicDepartmentController.getSingleAcademicDepartmentCont
)

router.patch('/update-academic-department/:departmentId',
    requestValidate(academicDepartmentValidation.UpdateAcademicDepartmentValidation),
