...
const createFacultyValidateSchema = z.object({
    body: z.object({
        ...
        faculty: z.object({
            ...
            emergencyContactNo: z.string().min(1, "Emergency Contact No. Must be required!!"),
    ...
    body: z.object({
        faculty: z.object({
            ...
            emergencyContactNo: z.string()
                ...
                .optional(),
            presentAddress: z.string().min(1, "Present Address required!!").optional(),
            permanentAddress: z.string().min(1, "Permanent Address required!!").optional(),
            profileImg: z.string().optional(),
